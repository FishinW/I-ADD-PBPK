...
# =============================================================================
# Save cross-species evaluation outputs
# =============================================================================
write.csv(combined, file.path("results", "tables", "mouse_rat_observed_predicted.csv"), row.names = FALSE)
write.csv(R2_by_organ, file.path("results", "tables", "mouse_rat_R2_by_organ.csv"), row.names = FALSE)
write.csv(data.frame(R2_overall_natural = R2_overall_nat,
                     R2_overall_log10 = R2_overall_log),
          file.path("results", "tables", "mouse_rat_R2_overall.csv"), row.names = FALSE)

ggsave(file.path("results", "figures", "mouse_rat_goodness_of_fit.png"),
       p_gof, width = 8.5, height = 7, units = "in", dpi = 600, bg = "white")
ggsave(file.path("results", "figures", "mouse_rat_model_evaluation.png"),
       combined_plot, width = 13, height = 6.5, units = "in", dpi = 600,
