# =============================================================================
# File: 06_model_rat_brain_iadd_auc.R
# Purpose: mrgsolve model definition for 06 model rat brain iadd auc.
...
FMAX_REL   : 0.928     : Max release propotion of 60-days release profile
KREL       : 0.0133    : 1/h first-order release rate from device 
