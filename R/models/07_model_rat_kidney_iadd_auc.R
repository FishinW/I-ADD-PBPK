# =============================================================================
# File: 07_model_rat_kidney_iadd_auc.R
# Purpose: mrgsolve model definition for 07 model rat kidney iadd auc.
...
// --- AUC states ---
AUC_PLASMA    : 0 : mg*h/L, plasma AUC
AUC_BRAIN     : 0 : mg*h/L, brain intracellular AUC
AUC_KIDNEY       : 0 : mg*h/L, kidney intracellular AUC
...
double CBR      = (ABR_VAS + ABR_INT + ABR_CEL)/ VBR;

// --- Plasma concentration (mg/L) ---
double CPLASMA = CV/BP;
...
capture CBRAIN_out         = CBR;

// --- AUC capture ---
capture AUC_PLASMA_out   = AUC_PLASMA;
capture AUC_BRAIN_out    = AUC_BRAIN;
capture AUC_KIDNEY_out   = AUC_KIDNEY;
